...
function paydiv() {
    ...
    $http({
            'url': 'http://web.archive.org/web/20160812142416/https://paydiv.io/access/paid/' + list.dataset.paydiv_product + '/',
            'method': "GET",
            'good': function (req) {
...
/*
     FILE ARCHIVED ON 14:24:16 Aug 12, 2016 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 03:43:59 Feb 21, 2018.
